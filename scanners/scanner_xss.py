...
def get_judgment_strings():
    judgment_strings = JudgementString()
    judgment_strings.strings += {"<script>alert('reflected xss run')"}
    return judgment_strings

def get_injection_strings():
    injection_strings = InjectionString()
    injection_strings.strings += {"<script>alert('reflected xss run')"}
